...
PennController.AddHost("https://amor.cms.hu-berlin.de/~petrenca/CrossConn_drawings/v3/"); // loads pictures from external server (pre-test 3 only)
...
PennController.Sequence("preloadPractice", "preloadCritical","preloadFillers","demographics", "practice_trials", "instructions", shuffle(randomize("critical_trials"),randomize("filler_trials")),"end_experiment", "post_questionnaire", "send", "final");

//====================================================================================================================================================================================================================
// 0. Preloading

CheckPreloaded( "practice_trials",5000)
...
CheckPreloaded( "critical_trials", 10000)
...
CheckPreloaded( "filler_trials", 10000)
...
//====================================================================================================================================================================================================================
// 2. Practice trials
PennController.Template( PennController.GetTable( "exp.v3_hu_complex.csv")// change this line for the appropriate experimental list
